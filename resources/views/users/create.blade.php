    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <x-string-field name="email" type="email" required="1" />
                <x-select-field name="user_role_id" label="Role:" selected="2" :items="$roles" required="1" />
                ...
                <x-upload-field name="image_file" label="Avatar image (required for veterinary):" required="0">
